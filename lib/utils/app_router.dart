...
class AppRouter {
  static List<GetPage<dynamic>> appRoute = [
    ...
    GetPage(name: ContactScreen.id, page: () => ContactScreen(),binding: CallBinding()),
    ...
    GetPage(name: AccessibilityScreen.id, page: () => AccessibilityScreen(), binding: AccessibiityBinding()),
    ...
    GetPage(name: LastseenAndOnlineScreen.id, page: () => LastseenAndOnlineScreen()),
    ...
    GetPage(name: DefaultMessageTimerScreen.id, page: () => DefaultMessageTimerScreen()),
    ...
    GetPage(name: PrivacyContactsScreen.id, page: () => PrivacyContactsScreen()),
    ...
    GetPage(name: PrivacyCheckupScreen1.id, page: () => PrivacyCheckupScreen1()),
    GetPage(name: PrivacyCheckupScreen2.id, page: () => PrivacyCheckupScreen2()),
    GetPage(name: PrivacyCheckupScreen3.id, page: () => PrivacyCheckupScreen3()),
    GetPage(name: PrivacyCheckupScreen4.id, page: () => PrivacyCheckupScreen4()),
    ...
    GetPage(name: ListCommunitiesScreen.id, page: () => ListCommunitiesScreen()),
    ...
    GetPage(name: SearchHelpCenterScreen.id, page: () => SearchHelpCenterScreen()),
    GetPage(name: GetStartedScreen.id, page: () => GetStartedScreen()),
    GetPage(name: HelpChatsScreen.id, page: () => HelpChatsScreen()),
    GetPage(name: ConnectBusinessesScreen.id, page: () => ConnectBusinessesScreen()),
    GetPage(name: VoiceAndVideoCallsScreen.id, page: () => VoiceAndVideoCallsScreen()),
    GetPage(name: HelpCommunitiesScreen.id, page: () => HelpCommunitiesScreen()),
    GetPage(name: ChannlesScreen.id, page: () => ChannlesScreen()),
    GetPage(name: PrivacySafetyScreen.id, page: () => PrivacySafetyScreen()),
    GetPage(name: AccountsAndAccountBansScreen.id, page: () => AccountsAndAccountBansScreen()),
    ...
    GetPage(name: SettingUpAnAccountScreen.id, page: () => SettingUpAnAccountScreen()),
    GetPage(name: ConnectingWithCustomersScreen.id, page: () => ConnectingWithCustomersScreen()),
    GetPage(name: SellingProductsAndServices.id, page: () => SellingProductsAndServices()),
    GetPage(name: BusinessTroubleshooting.id, page: () => BusinessTroubleshooting()),
    GetPage(name: PremiumFeaturesScreen.id, page: () => PremiumFeaturesScreen()),
    GetPage(name: BusinessPlatformScreen.id, page: () => BusinessPlatformScreen()),
    GetPage(name: ChannelsGetStartedScreen.id, page: () => ChannelsGetStartedScreen()),
    GetPage(name: ChannelFollowersAndViewersScreen.id, page: () => ChannelFollowersAndViewersScreen()),
    ...
    GetPage(name: PrivacySafetySecurityScreen.id, page: () => PrivacySafetySecurityScreen()),
    GetPage(name: DownloadAndInstallationScreen.id, page: () => DownloadAndInstallationScreen()),
    GetPage(name: RegistrationScreen.id, page: () => RegistrationScreen()),
    GetPage(name: LinkedDevicesScreen.id, page: () => LinkedDevicesScreen()),
    GetPage(name: TroubleshootingScreen.id, page: () => TroubleshootingScreen()),
    GetPage(name: HelpContactsScreen.id, page: () => HelpContactsScreen()),
    GetPage(name: StatusScreen.id, page: () => StatusScreen()),
    GetPage(name: IndividualAndGroupchatsScreen.id, page: () => IndividualAndGroupchatsScreen()),
    GetPage(name: BackUpAndRestoreScreen.id, page: () => BackUpAndRestoreScreen()),
    GetPage(name: NotificationsScreen.id, page: () => NotificationsScreen()),
    GetPage(name: MediaScreen.id, page: () => MediaScreen()),
    GetPage(name: VoiceMessagesAndChatsScreen.id, page: () => VoiceMessagesAndChatsScreen()),
    GetPage(name: VideoNotesScreen.id, page: () => VideoNotesScreen()),
    GetPage(name: AiExperiencesScreen.id, page: () => AiExperiencesScreen()),
    GetPage(name: ChatTroubleshootingScreen.id, page: () => ChatTroubleshootingScreen()),
    ...
    GetPage(name: SettingUpPaymentsScreen.id, page: () => SettingUpPaymentsScreen()),
    GetPage(name: PaymentsAndRequestsScreen.id, page: () => PaymentsAndRequestsScreen()),
    GetPage(name: SecurityAndPrivacyScreen.id, page: () => SecurityAndPrivacyScreen()),
    ...
    GetPage(name: VoiceTroubleshootingScreen.id, page: () => VoiceTroubleshootingScreen()),
    GetPage(name: FavoritesScreen.id, page: () => FavoritesScreen(), binding: CallBinding()),
    GetPage(name: CommunitiesScreen.id, page: () => CommunitiesScreen()),
    GetPage(name: DisappearingMessagesScreen.id, page: () => DisappearingMessagesScreen()),
    ...
    GetPage(name: ChatMessagesScreen.id, page: () => ChatMessagesScreen(), binding: ChatBinding()),
    GetPage(name: StatusViewScreen.id, page: () {
