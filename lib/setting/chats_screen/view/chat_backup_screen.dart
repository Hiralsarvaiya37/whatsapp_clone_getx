...
import 'package:whatsapp_clone_getx/setting/chats_screen/view/end_to_end_screen.dart';
import 'package:whatsapp_clone_getx/utils/app_colors.dart';
import 'package:whatsapp_clone_getx/utils/app_size.dart';

class ChatBackupScreen extends StatelessWidget {
   ChatBackupScreen({super.key});

  final ChatViewController chatController = Get.find();
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    ()=> radioTile(
                                        "abcced123@gmail.com",
                                        dialogSetState,
                                        chatController.selectedGoogleAccount.value,
                                      ),
                                    ),
                                    SizedBox(height: AppSize.getSize(30)),
                                    Obx(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    ()=> radioTile(
                                        "Daily",
                                        dialogSetState,
                                        chatController.backupFrequency.value,
                                      ),
                                    ),
                                    SizedBox(height: AppSize.getSize(30)),
                                    Obx(
  ...
  Widget appTile(String title, int index) {
     return Obx((){
       bool switchValue = index == 1 ? chatController.isOn1.value : chatController.isOn2.value;
    return InkWell(
      onTap: () {
        if (index == 1) {
          chatController.isOn1.value = !chatController.isOn1.value;
        } else if (index == 2) {
          chatController.isOn2.value = !chatController.isOn2.value;
        }
    },
      child: Row(
        children: [
      ...
      onTap: () {
        dialogSetState(() {
          if (title == "abcced123@gmail.com" || title == "Add account") {
            chatController.selectedGoogleAccount.value = title;
          } else {
            chatController.backupFrequency.value = title;
          }
        });
      },
      child: Row(
