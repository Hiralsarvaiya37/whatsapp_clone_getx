            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  appInfo("About registration and two-step verification", context),
                  appInfo("How to register your account with a phone call", context),
                  appInfo("About automatic phone number verification", context),
                  appInfo("Can't complete registration", context),
                  appInfo("How to manage two-step verification settings", context),
                  appInfo("How to reset your two-step verification PIN", context),
                  appInfo("Can't request another verification code without waiting", context),
                  appInfo("I'm travelling and I can't get my WhatsApp code", context),
                  appInfo("Received verification code without requesting it.", context),
