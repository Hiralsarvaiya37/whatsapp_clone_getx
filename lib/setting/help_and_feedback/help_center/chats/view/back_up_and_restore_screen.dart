            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  appInfo("How to move chats from an Android device to an iPhone", context),
                  appInfo("How to move chats from an iPhone to an Android device", context),
                  appInfo("About end-to-end encrypted backup", context),
                  appInfo("About Google Account backups", context),
                   appInfo("How to turn off WhatsApp in your device backup", context),
