            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  appInfo("About 'Waiting for this message. This may take a while.'", context),
                  appInfo("Seeing 'Waiting for this message. Check your phone'", context),
                  appInfo("Fix incorrect timestamps on messages", context),
                  appInfo("Can't remember password for encrypted backup", context),
                  appInfo("Can't back up or restore your chat history", context),
                  appInfo("Can't move chats from an Android device to an iPhone", context),
                  appInfo("Can't move chats from an iPhone to an Android device", context),
                  ...
                  appInfo("Can't hear voice messages, status audio, or videos", context),
                  appInfo("Can't record voice messages", context),
                  appInfo("Seeing blurry photos", context),
                  appInfo("Can't send longer videos", context),
                  appInfo("What does 'Invite via Link unavailable' mean?", context),
