            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  appInfo("About AI experiences available through WhatsApp", context),
                  appInfo("About using AI experiences available through WhatsApp", context),
                  appInfo("About Meta AI", context),
                  appInfo("How to chat with Meta AI", context),
                  appInfo("How to chat with Meta AI in an individual or group chat", context),
                  appInfo("About searching WhatsApp and asking Meta AI", context),
                  appInfo("How to ask Meta AI in the WhatsApp search bar", context),
                  appInfo("How to create an animated AI image in a chat", context),
                  appInfo("How to generate an AI image for your profile photo or group icon", context),
                  appInfo("How to edit AI-generated images", context),
                  appInfo("How to edit your photos or images with Meta AI", context),
                  appInfo("How to prompt Meta AI with an image", context),
                  appInfo("How to create and use AI-generated call backgrounds", context),
                  appInfo("How to share an AI-generated image to your status", context),
                  appInfo("About AIs", context),
                  appInfo("How to chat with AIs", context),
                  appInfo("How to report an AI", context),
                  appInfo("About creating an AI through Meta AI Studio", context),
                  appInfo("How to create an AI through Meta AI studio", context),
                  appInfo("How to edit your AI through Meta AI Studio", context),
                  appInfo("How to delete your AI through Meta AI Studio", context),
                  appInfo("About AI stickers", context),
                  appInfo("How to create and share AI stickers", context),
                  appInfo("About the availbility of AI experiences available through WhatsApp", context),
