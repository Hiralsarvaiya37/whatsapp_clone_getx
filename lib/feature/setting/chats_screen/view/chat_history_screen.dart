...
class ChatHistoryScreen extends StatelessWidget {
          ...
          children: [
            ...
            Obx(
              ()=> InkWell(
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    InkWell(
                                        onTap: () {
                                            chatController.isArchived.value = !chatController.isArchived.value;
                                          Navigator.pop(context);
                                        },
                                        child: Text(
                                          "Ok",
                ...
                child: appInfo(
                  chatController.isArchived.value ? "Unarchive all chats" : "Archive all chats",
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                InkWell(
                                  onTap: () {
                                    dialogSetState(() {
                                      chatController.deleteMedia.value = !chatController.deleteMedia.value;
                                    });
                                  },
                                  child: Column(
                                    children: [
  ...
  Widget deleteOptionTile(int index, String title, StateSetter dialogSetState) {
   return Obx((){
     bool isSelected = chatController.selectedDeleteOption.value == index;

    return InkWell(
      onTap: () {
        dialogSetState(() {
          chatController.selectedDeleteOption.value = isSelected ? 0 : index;
        });
      },
      child: Row(
        children: [
