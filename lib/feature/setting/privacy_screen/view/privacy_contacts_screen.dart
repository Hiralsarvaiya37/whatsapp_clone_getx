...
class PrivacyContactsScreen extends StatelessWidget {
   PrivacyContactsScreen({super.key});

  final PrivacyViewController contactsController = Get.find();
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  Obx(
                    ()=> Switch(
                      value: contactsController.isOn.value,
                      ...
                      onChanged: (val) {
                          contactsController.isOn.value = val;
                      },
                    ),
                  ),
                ],
