...
void _toggleAppUpdateOption(ToggleAppUpdateOption event, Emitter<SettingState> emit) {
    switch (event.index) {
      case 1:
...
void _toggleMediaVisibility(ToggleMediaVisibility event, Emitter<SettingState> emit) {
  emit(state.copyWith(isMediaVisibility: event.value));
}

void _toggleKeepChatsArchived(ToggleKeepChatsArchived event, Emitter<SettingState> emit) {
