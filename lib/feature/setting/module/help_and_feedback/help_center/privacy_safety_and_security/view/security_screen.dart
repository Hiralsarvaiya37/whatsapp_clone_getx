            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  appInfo("Account security tips", context),
                  appInfo("Turn chat lock on or off", context),
                  appInfo("How to recover a compromised account", context),
                  appInfo("About security code change notifications", context),
                  appInfo("Protecting users from spyware", context),
                  appInfo(
                    "About autofilling security codes on WhatsApp",
                    context,
                  ),
                  appInfo(
                  ...
                  appInfo(
                    "Protecting our users from a video calling cyber attack",
                    context,
                  ),
                  appInfo(
                    "About the Goggle warning 'This app is fake...'",
                    context,
                  ),
                  appInfo(
                    "How to unlink a device you don't recognize",
                    context,
                  ),
